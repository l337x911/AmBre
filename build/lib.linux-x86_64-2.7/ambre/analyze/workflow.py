...
def main():
  ...
  parser.add_argument('--multi-breaks', type=str, nargs='?', default=None, dest="multi_breaks", help='Flag for repeating template creation using editted .bp file (see README).\n temptag must be defined')
